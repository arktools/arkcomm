...
macro(build_arkcomm TAG EP_BASE_DIR)
    if(NOT ARKCOMM_FOUND)
        ...
        set(ARKCOMM_INCLUDE_DIRS ${EP_BASE_DIR}/${CMAKE_INSTALL_PREFIX}/include)
        set(ARKCOMM_LIBRARIES ${EP_BASE_DIR}/${CMAKE_INSTALL_PREFIX}/lib/libarkcomm.a)
