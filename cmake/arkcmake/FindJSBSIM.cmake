...
macro(build_jsbsim TAG EP_BASE_DIR)
    if(NOT JSBSIM_FOUND)
        ...
        set(JSBSIM_DATA_DIR ${EP_BASE_DIR}/${CMAKE_INSTALL_PREFIX}/share/jsbsim)
        set(JSBSIM_LIBRARIES ${EP_BASE_DIR}/${CMAKE_INSTALL_PREFIX}/lib/libjsbsim.a)
